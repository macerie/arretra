package com.example.application.views.trattamenti;
...
@PageTitle("Trattamenti")
@Route(value = "Trattamenti", layout = MainLayout.class)
@PermitAll
@Uses(Icon.class)
public class TrattamentiView extends Div {
    ...
    public TrattamentiView(SamplePersonService SamplePersonService) {
        this.samplePersonService = SamplePersonService;
        setSizeFull();
        addClassNames("trattamenti-view");
